...
/*
 * GameQ - Breed protocol (http://gameq.sf.net)
...
$d = substr($data[0], 5, strlen($data[0])-5);
$strlen = strlen($d);
$output['server_name'] = $this->aux->HLString($d, $i);
$output['map']         = $this->aux->HLString($d, $i);
$output['game_type']   = $this->aux->HLString($d, $i);
$output['num_players'] = $this->aux->HLString($d, $i);
$output['max_players'] = $this->aux->HLString($d, $i);
?>